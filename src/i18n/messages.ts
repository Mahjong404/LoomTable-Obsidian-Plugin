export const englishMessages = {
  ...
  "connection.status.incompatibleApi":
    "This Plugin requires API v1; the Server reported",
  ...
  "connection.status.notTested":
    "Connection has not been tested in this session.",
  ...
  "error.invalidOrigin":
    "Enter an absolute HTTP(S) server origin without credentials.",
  "grid.base": "Base",
  ...
  "grid.error.offline":
    "You are offline. Reconnect and retry the Grid request.",
  ...
  "record.attachment.status.pendingHint":
    "Wait for the attachment to finish processing.",
  "record.attachment.status.staleHint":
    "Refresh the Record or replace this attachment reference.",
  "record.attachment.status.invalidHint":
    "Check the attachment reference before saving.",
  "record.attachment.status.unknownHint":
    "Refresh the Record before using this attachment.",
  ...
  "record.attachment.action.downloadFailed":
  ...
  "record.attachment.action.openFailed":
    "Open failed. Check the attachment and try again.",
  "record.attachment.action.preview": "Preview",
  "record.attachment.action.previewing": "Previewing…",
  "record.attachment.action.previewFailed":
    "Preview failed. Check the attachment and try again.",
  "record.attachment.action.offlineOpenPreview":
    "Offline. Reconnect to open or preview.",
  ...
  "record.attachment.preview.description":
    "Read-only preview. No Vault file is written.",
  ...
  "record.attachment.action.offlineAdd":
    "Offline. Reconnect to add an attachment.",
  "record.attachment.addAuth":
    "Authentication is required to add an attachment. Check Connection Settings.",
  "record.attachment.addForbidden":
    "You do not have permission to add an attachment.",
  ...
  "record.attachment.addCapability":
    "Attachment upload is not available on this Server.",
  ...
  "map.customUrlDescription":
    "Use {z}, {x}, and {y}; non-loopback origins must use HTTPS.",
  ...
  "settings.saveFailed":
    "Settings could not be saved. Review the values and try again.",
  "settings.saveInProgress":
    "Another settings change is being saved. Try again in a moment.",
  "settings.title": "LoomTable",
  "view.configure":
    "Configure a connection profile in LoomTable settings to get started.",
  ...
  "record.location.clearConfirm":
    "Clear this Location value? This cannot be undone.",
  "record.location.unsetConfirm":
    "Unset this Location field? This cannot be undone.",
  ...
  "validation.fieldValue.textControl":
  ...
  "validation.fieldValue.longTextControl":
  ...
  "validation.fieldValue.multiSelectType":
    "Multi-select value must contain option IDs.",
  "validation.fieldValue.multiSelectInvalid":
  ...
  "validation.fieldValue.locationObject":
    "Location must be an object or cleared.",
  "validation.fieldValue.locationUnsupportedMember":
  ...
  "validation.fieldValue.locationPrecisionInvalid":
